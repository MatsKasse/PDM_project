...
dynamic_sphere_obstacles_dicts = [
    {
        "type": "sphere",
        "geometry": {"trajectory": ["-10 + 0.6 * t", "2.6", "0.2"], "radius": 0.3},
        "rgba": [1.0, 0.2, 0.2, 1.0],
    },
    {
        "type": "sphere",
        "geometry": {"trajectory": ["-0.5", "-2 + 0.6 * t", "0.2"], "radius": 0.3},
        "rgba": [1.0, 0.2, 0.2, 1.0],
    },
    {
        "type": "sphere",
        "geometry": {"trajectory": ["10 - 0.6 *t", "-6.3", "0.2"], "radius": 0.30},
        "rgba": [1.0, 0.2, 0.2, 1.0],
    },
    {
        "type": "sphere",
        "geometry": {"trajectory": ["-1.3-0.4*t", "8.9 - 0.4*t", "0.2"], "radius": 0.30},
        "rgba": [1.0, 0.2, 0.2, 1.0],
    }
    # ,
    # {
    #     "type": "sphere",
    #     "geometry": {"trajectory": ["9", "0+0.1*t", "0.2"], "radius": 0.30},
    #     "rgba": [1.0, 0.2, 0.2, 1.0],
    # }
]
